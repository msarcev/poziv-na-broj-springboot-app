 ...
 */
public class PozivNaModel_64 implements IPozivNaBroj {
    ...
    public boolean validatePoziv(String kod) {
        ...
        if (kod.contains("-")) {
            ...
            if ( nOfParts == 3 && kod.length() > 12){
                valid=false;
                msgErrorCode="poziv.podatak.treci.neispravan";
                return valid;
            }
            if ( nOfParts == 4 && kod.length() > 9){
                valid=false;
    ...
    public static void main(String[] args) {
        ...
        String test = "6112-127-12312312-123";
